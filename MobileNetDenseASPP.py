...
from MobileNetDenseASPP_config import Model_CFG
...
if __name__ == "__main__":
    ...
    input_tensor = Variable(torch.randn(1, 3, 512, 512))
    net = DenseASPP()
    net = nn.DataParallel(net).cuda(0)
    ...
    print('total parameter:', netParams(net))
    model_name = 'mobilenetDenseASPP.pth'
