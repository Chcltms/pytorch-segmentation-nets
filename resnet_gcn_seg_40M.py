...
class ResnetGCNSegmentation(nn.Module):
    def __init__(self, class_num=6, resnet_depth=18, kernal_size=15, feature_num=21, init_resnet_state_path=None,
        ...
        super(ResnetGCNSegmentation, self).__init__()
...
if __name__ == "__main__":
    ...
    model_name = '/root/lsb/coco_train/resnet_gcn_seg.pth'
